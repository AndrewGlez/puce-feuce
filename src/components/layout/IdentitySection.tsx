      ...
      <div className="flex xl:px-12 2xl:p-0 flex-col md:flex-row gap-10 justify-center w-full max-w-7xl">
        ...
        <div className="flex-1 bg-[#D9D9D9] rounded-lg shadow-md border-t-8 border-[#223C51] px-10 py-8 flex flex-col justify-between min-w-[400px] max-w-[700px] h-[340px]">
          <div className="flex items-center mb-4">
            ...
            <span className="text-4xl font-bold text-feuce-primary font-geologica">
              Misión
            </span>
          </div>
          ...
          <div className="flex flex-row flex-wrap gap-3 mt-2">
            <span className="bg-feuce-primary text-white rounded-lg px-3 py-1 font-semibold text-sm">
              Representación
            </span>
            <span className="bg-feuce-primary text-white rounded-lg px-3 py-1 font-semibold text-sm">
              Participación
        ...
        <div className="flex-1 bg-[#D9D9D9] rounded-lg shadow-md border-t-8 border-[#3B7C3C] px-10 py-8 flex flex-col justify-between min-w-[400px] max-w-[700px] h-[340px]">
          <div className="flex items-center mb-4">
            ...
            <span className="text-4xl font-bold text-feuce-primary rounded-lg px-3 py-1 font-geologica">
              Visión
            </span>
          </div>
          <div className="flex-1 flex flex-col justify-center">
